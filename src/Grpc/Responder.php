 ...
 *
 * The success verb lives on the response axis — {@see UnaryResponder} takes one message,
 * {@see StreamingResponder} drains a generator. Failing lives here: every kind fails the
 * same way.
 */
