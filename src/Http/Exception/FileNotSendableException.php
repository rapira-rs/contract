...
/**
 * The host could not send the file {@see \Rapira\Http\Exchange::sendFile()} named: nothing at that path, not a regular
 ...
 */
class FileNotSendableException extends \RuntimeException implements RapiraThrowable {}
